...
<%@include file="../top.jsp"%>
	...
	<form class="form-signin" action="${ctx}/accounts/insertUser" method="post">
		<label for="inputinsertUserid" class="sr-only">UserId</label> <input
			type="insertUserid" id="inputinsertUserid" class="form-control"
			placeholder="insertUserid" required autofocus name="insertUserid">
